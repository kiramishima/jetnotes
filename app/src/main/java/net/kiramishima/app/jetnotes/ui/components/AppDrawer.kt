...
private fun ScreenNavigationButton(
    ...
    // of the buttons: selected/unselected
    ...
    Surface( // 1
        ...
        Row( // 2
            ...
            Spacer(modifier = Modifier.width(16.dp)) // 3
            Text(
                text = label,
...
fun AppDrawer(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        ScreenNavigationButton(icon = Icons.Filled.Delete, label = "Trash", isSelected = currentScreen == Screen.Trash,
            onClick = {
